...
<div>
    <div style="height: 100px; background-color: lightblue; text-align: center">
        ...
        <div style='margin-left: 1200px'><a href="login.php"><button class='btn btn-dark'>Login</button></a> // <a href="register.php"><button class='btn btn-dark'>Registrar</button></a></div>
    </div>
